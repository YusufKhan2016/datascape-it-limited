<template>
    <header>
        ...
        <div class="bg-black w-full fixed z-[1000]">
            <div
            class="container h-18 flex items-center justify-between mx-auto"
            >
                ...
                <div>
                    <div class="hidden lg:flex items-center font-[500] text-zinc-50 space-x-6 px-5">
                        ...
                        <router-link to="contacts" class="bg-gradient-to-r rounded-3xl from-blue-900 to-green-800 px-4 py-2">
                            Contact us
                        </router-link>
                    </div>
